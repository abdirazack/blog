<?php
    ...
    if(isset($_POST['displaysend'])){
        ...
        $query=mysqli_query($conn,"select * from posts  order by viewCount desc limit 3");
...
<div class="card m-1 p-0" style="width: 100%;">
    ...
    <style>
        ...
        <Button onclick="viewPost()" class="btn btn-succes h-100 m-0 p-0 w-100 " style="font-family: 'poppins'; font-weight:600;">View Post</Button>
    </div>
...
<script>
function viewPost() {
    window.location.assign('./userReg.php');
}
</script>